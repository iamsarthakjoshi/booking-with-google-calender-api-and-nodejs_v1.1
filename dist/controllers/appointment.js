    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _logger["default"].info('Serving /days request', req.query);
          ...
          case 7:
            ...
            _logger["default"].info('Timeslots status for each day are fetched!');
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _logger["default"].info('Serving /timeslots request with', req.query);
          ...
          case 7:
            ...
            _logger["default"].info('Timeslots are fetched!');
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _logger["default"].info('Serving /book request with', req.query);
          ...
          case 7:
            ...
            _logger["default"].info('Appointment booked!', bookedTimeSlot);
          ...
          case 12:
            ...
            _logger["default"].error(_context3.t0.message, {
              stacktrace: _context3.t0.stack
            });
